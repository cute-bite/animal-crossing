(function(){
  ...
  const controls = document.getElementById('sea-controls');
  const monthSel = document.getElementById('month-select-sea') || document.getElementById('month-select');
  const availOnly = document.getElementById('available-only-sea') || document.getElementById('available-only');
