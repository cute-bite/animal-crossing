(function(){
  ...
  const controls = document.getElementById('bugs-controls');
  const monthSel = document.getElementById('month-select-bugs') || document.getElementById('month-select');
  const availOnly = document.getElementById('available-only-bugs') || document.getElementById('available-only');
